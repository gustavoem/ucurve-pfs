...
%A complexidade do algoritmo de seleção de características
%depende da complexidade da função de custo e do algoritmo de busca
%utilizados, mas em termos práticos esse problema costuma ser NP-difícil. 
