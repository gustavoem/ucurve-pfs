...
como o \algname{PFS} e \algname{UBB-PFS}. Desta maneira, este algoritmo 
não é um dos mais recomendados para este tipo de instâncias.

Entretanto, o \algname{PUCS} se mostrou mais interessante quando 
utilizado para resolver instâncias de maneira sub-ótima. Para estes 
experimentos, o \algname{PUCS} teve tempo médio de execução pior do que 
