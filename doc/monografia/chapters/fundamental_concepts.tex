...
%Por isso, a entropia condicional média não é uma função de custo 
%apropriada para o problema de seleção de características, pois ela não

%portanto, especificamos melhor o vetor de entrada, concentrando a 
%distribuição de $\probability (Y | \mathbf{x})$.
