...
testes foram feitos com instâncias artificiais do problema U-Curve 
usando a função de soma de subconjuntos.
%TODO: server specs
...
\caption{Comparação entre o \algname{PFS} e \algname{PFS\_RAND}.
O tempo de execução do segundo é maior do que o primeiro
enquanto a quantidade de chamadas da função custo é parecida em 
ambos.} \label{tab:pfs_vs_pfsrand}
\end{table}
...
do código. Se ela nunca for verdadeira, então o \algname{UBB-PFS} deve 
