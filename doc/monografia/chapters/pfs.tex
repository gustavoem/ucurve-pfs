...
aproximado, o que não seria possível quando se considera o vetor de 
adjacências.
...
implementação precisamos modificar estes diagramas para que eles 
...
de raízes, dado que ela se mostrou semânticamente equivalente a
...
da raíz até uma folha não vazia (que contenha um nó) guardando os 
