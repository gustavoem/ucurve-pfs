...
#include "algorithms/PFSROBDDTest.h"
#include "algorithms/PosetForestSearchTest.h"
#include "algorithms/RUBBTest.h"
#include "algorithms/RUBB2Test.h"
#include "algorithms/PFS_RANDTest.h"
#include "algorithms/PFS_LEFTMOSTTest.h"
#include "algorithms/RPFSTest.h"
#include "algorithms/RPFS_LEFTMOSTTest.h"
#include "algorithms/PPFSTest.h"
#include "algorithms/RPFS_RANDTest.h"
#include "algorithms/PUCSTest.h"
#include "algorithms/UBB_PFSTest.h"
...
int main (void)
{
  ...
  //Testing class "PFSROBDD"
  //
  current_class = "PFSROBDDTest";
  result ("it_should_store_all_the_visited_subsets",
    PFSROBDDTest::it_should_store_all_the_visited_subsets ());
  result ("it_should_give_the_number_of_the_visited_subsets",
    PFSROBDDTest::it_should_give_the_number_of_the_visited_subsets ());
  cout << endl;

  //Testing class "PosetForestSearch"
  //
  current_class = "PosetForestSearchTest";
  result ("it_should_store_all_the_visited_subsets",
    PosetForestSearchTest::it_should_store_all_the_visited_subsets ());
  result ("it_should_give_the_number_of_the_visited_subsets",
  ...
  //Testing class "RUBB2"
  //
  current_class = "RUBB2Test";
  result ("it_should_store_all_the_visited_subsets",
    RUBB2Test::it_should_store_all_the_visited_subsets ());
  result ("it_should_give_the_number_of_the_visited_subsets",
    RUBB2Test::it_should_give_the_number_of_the_visited_subsets ());
  cout << endl;

  //Testing class "PFS_RAND"
  //
  current_class = "PFS_RANDTest";
  result ("it_should_store_all_the_visited_subsets",
    PFS_RANDTest::it_should_store_all_the_visited_subsets ());
  result ("it_should_give_the_number_of_the_visited_subsets",
    PFS_RANDTest::it_should_give_the_number_of_the_visited_subsets ());
  cout << endl;

  //Testing class "PFS_LEFTMOST"
  //
  current_class = "PFS_LEFTMOSTTest";
  result ("it_should_store_all_the_visited_subsets",
    PFS_LEFTMOSTTest::it_should_store_all_the_visited_subsets ());
  result ("it_should_give_the_number_of_the_visited_subsets",
    PFS_LEFTMOSTTest::it_should_give_the_number_of_the_visited_subsets ());
  cout << endl;

  //Testing class "RPFS"
  //
  current_class = "RPFSTest";
  result ("it_should_store_all_the_visited_subsets",
    RPFSTest::it_should_store_all_the_visited_subsets ());
  result ("it_should_give_the_number_of_the_visited_subsets",
    RPFSTest::it_should_give_the_number_of_the_visited_subsets ());
  cout << endl;

  //Testing class "RPFS_LEFTMOST"
  //
  current_class = "RPFS_LEFTMOSTTest";
  result ("it_should_store_all_the_visited_subsets",
    RPFS_LEFTMOSTTest::it_should_store_all_the_visited_subsets ());
  result ("it_should_give_the_number_of_the_visited_subsets",
    RPFS_LEFTMOSTTest::it_should_give_the_number_of_the_visited_subsets ());
  cout << endl;

  //Testing class "PPFS"
  //
  current_class = "PPFSTest";
  result ("it_should_store_all_the_visited_subsets",
    PPFSTest::it_should_store_all_the_visited_subsets ());
  result ("it_should_give_the_number_of_the_visited_subsets",
    PPFSTest::it_should_give_the_number_of_the_visited_subsets ());
  cout << endl;

  //Testing class "RPFS_RAND"
  //
  current_class = "RPFS_RANDTest";
  result ("it_should_store_all_the_visited_subsets",
    RPFS_RANDTest::it_should_store_all_the_visited_subsets ());
  result ("it_should_give_the_number_of_the_visited_subsets",
    RPFS_RANDTest::it_should_give_the_number_of_the_visited_subsets ());
  cout << endl;
  ...
  //Testing class "UBB_PFS"
  //
  current_class = "UBB_PFSTest";
  result ("it_should_store_all_the_visited_subsets",
    UBB_PFSTest::it_should_store_all_the_visited_subsets ());
  result ("it_should_give_the_number_of_the_visited_subsets",
    UBB_PFSTest::it_should_give_the_number_of_the_visited_subsets ());
  cout << endl;
