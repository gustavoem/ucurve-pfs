// PFSROBDD.cpp automatically generated by bin/add_new_algorithm.pl
// in Tue Jul 25 13:25:58 2017.

//
// PFSROBDD.cpp -- implementation of the class "PFSROBDD".
//
...
void PFSROBDD::get_minima_list (unsigned int max_size_of_minima_list)
{
...
PFSROBDD::Node * PFSROBDD::lower_forest_branch
...
PFSROBDD::Node * PFSROBDD::upper_forest_branch
     (map<string, Node *> * Forest_A, map<string, Node *> * Forest_B)
{
  map<string, Node *>::iterator it;
  Node * R, * M, * N;
...
void PFSROBDD::search_upper_root
...
void PFSROBDD::search_lower_root
...
void PFSROBDD::search_lower_children
...
void PFSROBDD::search_upper_children
...
void PFSROBDD::upper_forest_pruning
...
void PFSROBDD::lower_forest_pruning
