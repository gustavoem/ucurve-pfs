...
#include "algorithms/PFSROBDD.h"
#include "algorithms/PosetForestSearch.h"
#include "algorithms/RUBB.h"
#include "algorithms/RUBB2.h"
#include "algorithms/PFS_RAND.h"
#include "algorithms/PFS_LEFTMOST.h"
#include "algorithms/RPFS.h"
#include "algorithms/RPFS_LEFTMOST.h"
#include "algorithms/PPFS.h"
#include "algorithms/RPFS_RAND.h"
#include "algorithms/PUCS.h"
#include "algorithms/UBB_PFS.h"
...
int main(int argc, char * argv[])
{
  ...
  if (0)
    ...
    solver = new BFS ();
  else if (algorithm.compare ("pfsrobdd") == 0)
    solver = new PFSROBDD ();
  else if (algorithm.compare ("pfs") == 0)
    solver = new PosetForestSearch ();
  else if (algorithm.compare ("rubb") == 0)
    solver = new RUBB ();
  else if (algorithm.compare ("rubb2") == 0)
    solver = new RUBB2 ();
  else if (algorithm.compare ("pfs_rand") == 0)
    solver = new PFS_RAND ();
  else if (algorithm.compare ("pfs_leftmost") == 0)
    solver = new PFS_LEFTMOST ();
  else if (algorithm.compare ("rpfs") == 0)
    solver = new RPFS ();
  else if (algorithm.compare ("rpfs_leftmost") == 0)
    solver = new RPFS_LEFTMOST ();
  else if (algorithm.compare ("ppfs") == 0)
    solver = new PPFS ();
  else if (algorithm.compare ("rpfs_rand") == 0)
    solver = new RPFS_RAND ();
  else if (algorithm.compare ("pucs") == 0)
    solver = new PUCS (p, l);
  else if (algorithm.compare ("ubb_pfs") == 0)
    solver = new UBB_PFS ();
  else
    return EXIT_FAILURE;
  ...
  for (i = 1; i < argc; i++)
  {
    ...
    else if ( (strcmp(argv[i],"-a") == 0) && ((i+1) < argc) )
    {
      ...
      if ( (0)  
          ...
          || (strcmp (argv[i], "sbs") == 0)
          || (strcmp (argv[i], "bfs") == 0)
          || (strcmp (argv[i], "pfsrobdd") == 0)
          || (strcmp (argv[i], "pfs") == 0)
          || (strcmp (argv[i], "rubb") == 0)
          || (strcmp (argv[i], "rubb2") == 0)
          || (strcmp (argv[i], "pfs_rand") == 0)
          || (strcmp (argv[i], "pfs_leftmost") == 0)
          || (strcmp (argv[i], "rpfs") == 0)
          || (strcmp (argv[i], "rpfs_leftmost") == 0)
          || (strcmp (argv[i], "ppfs") == 0)
          || (strcmp (argv[i], "rpfs_rand") == 0)
          || (strcmp (argv[i], "pucs") == 0)
          || (strcmp (argv[i], "ubb_pfs") == 0)
         )
      {
        a->clear ();
        a->append (argv[i]);
