...
OBJS =		src/Element.o src/ElementSet.o src/ElementSubset.o \
      ...
      src/algorithms/PFSROBDD.o \
      src/algorithms/PosetForestSearch.o \
      src/algorithms/RUBB.o \
      src/algorithms/RUBB2.o \
      src/algorithms/PFS_RAND.o \
      src/algorithms/PFS_LEFTMOST.o \
      src/algorithms/RPFS.o \
      src/algorithms/RPFS_LEFTMOST.o \
      src/algorithms/PPFS.o \
      src/algorithms/RPFS_RAND.o \
      src/algorithms/PUCS.o \
      src/algorithms/UBB_PFS.o \
...
TOBJS =		test/ElementTest.o test/ElementSetTest.o \
      ...
      test/algorithms/PFSROBDDTest.o \
      test/algorithms/PosetForestSearchTest.o \
      test/algorithms/RUBBTest.o \
      test/algorithms/RUBB2Test.o \
      test/algorithms/PFS_RANDTest.o \
      test/algorithms/PFS_LEFTMOSTTest.o \
      test/algorithms/RPFSTest.o \
      test/algorithms/RPFS_LEFTMOSTTest.o \
      test/algorithms/PPFSTest.o \
      test/algorithms/RPFS_RANDTest.o \
      test/algorithms/PUCSTest.o \
      test/algorithms/UBB_PFSTest.o \
